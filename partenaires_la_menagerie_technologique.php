...
<html>
	<head>
		<meta charset="utf-8" />
		<link rel="stylesheet" media="screen" type="text/css" href="css/partenaires.css" />
	...
	<body>
		...
		<header>
			<div id="arborescence"><p><a href="index.html">accueil</a> &gt; partenaires</p></div>
		...
		<nav>
			...
			<div id="onglet_actif"><img src="images/menu_onglets/partenaires.png" alt="partenaires" width="140" height="35" /></div>
