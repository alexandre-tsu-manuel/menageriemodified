...
<html>
	<head>
		<meta charset="utf-8" />
		<link rel="stylesheet" media="screen" type="text/css" href="css/espacepro.css" />
	...
	<body>
		...
		<header>
			<div id="arborescence"><p><a href="index.html">accueil</a> &gt; espace pro</p></div>
		...
		<nav>
			...
			<div id="onglet_actif"><img src="images/menu_onglets/espacepro.png" alt="espace pro" width="140" height="35" /></div>
			<div id="contact"><p><a href="contact_la_menagerie_technologique.html">contact</a></p></div>
		</nav>
		<section>
			<div id="left_photo">
				<img src="images/espacepro/left_photo.jpg" alt="robot" />
			</div>
		</section>
