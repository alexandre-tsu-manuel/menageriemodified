...
<html>
	...
	<body>
		...
		<header>
			<div id="arborescence"><p><span class="gt"><a href="../index.html">accueil</a> &gt; <a href="index.php">administration</a> &gt;</span> informations</p></div>
		...
		<nav>
			...
			<div id="informations_png"><p><img src="../images/admin/menu/informationsOn.png" /></p></div>
			<div id="informations"><p class="nav-Nlien"><a>informations</a></p></div>
			<div id="identifiants_png"><p><img src="../images/admin/menu/identifiants.png" /></p></div>
			<div id="identifiants"><p><a href="changepass.html">indentifiants</a></p></div>
			<div id="comptes_png"><p><img src="../images/admin/menu/comptes.png" /></p></div>
			<div id="comptes"><p><a href="comptes.html">comptes</a></p></div>
			<div id="deconnexion_png"><p><img src="../images/admin/menu/deconnexion.png" /></p></div>
			<div id="deconnexion"><p><a href="disconnect.html">déconnexion</a></p></div>
		</nav>
		<section id="form">
