...
<html>
	<head>
		<meta charset="utf-8" />
		<link rel="stylesheet" media="screen" type="text/css" href="css/specatcles.css" />
		<link rel="stylesheet" media="screen" type="text/css" href="css/style.css" />
		<!--[if lt IE 9]>
		<script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script>
		<![endif]-->
		<title>Spectacle de robots à caractère scientifique avec la Ménagerie Technologique</title>
	</head>
	<body>
		<?php include('includes/menu_admin.php'); ?>
		<header>
			<div id="arborescence"><p><a href="index.html">accueil</a> &gt; spectacles</p></div>
		...
		<nav>
			...
			<div id="onglet_actif"><img src="images/menu_onglets/spectacles.png" alt="spectacles" width="140" height="35" /></div>
