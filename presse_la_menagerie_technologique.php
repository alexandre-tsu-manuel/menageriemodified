...
<html>
	<head>
		<meta charset="utf-8" />
		<link rel="stylesheet" media="screen" type="text/css" href="css/presse.css" />
		<link rel="stylesheet" media="screen" type="text/css" href="css/style.css" />
		<!--[if lt IE 9]>
		<script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script>
		<![endif]-->
		<title>_LA_MÉNAGERIE_TECHNOLOGIQUE</title>
	</head>
	<body>
		<?php include('includes/menu_admin.php'); ?>
		<header>
			<div id="arborescence"><p><a href="index.html">accueil</a> &gt; presse</p></div>
		...
		<nav>
			...
			<div id="onglet_actif"><img src="images/menu_onglets/presse.png" alt="presse" width="140" height="35" /></div>
		...
		<section>
			<div id="left_photo">
				<img src="images/presse/left_photo.jpg" alt="robot staubli dessinateur" />
			</div>
		</section>
