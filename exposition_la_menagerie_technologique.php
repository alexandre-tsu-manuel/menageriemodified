...
<html>
	<head>
		<meta charset="utf-8" />
		<link rel="stylesheet" media="screen" type="text/css" href="css/exposition.css" />
		<link rel="stylesheet" media="screen" type="text/css" href="css/style.css" />
		<!--[if lt IE 9]>
		<script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script>
		<![endif]-->
		<title>Exposition scientifique interactive de robots avec la Ménagerie Technologique</title>
	</head>
	<body>
		<?php include('includes/menu_admin.php'); ?>
		<header>
			<div id="arborescence"><p><a href="index.html">accueil</a> &gt; exposition</p></div>
			<?php include("includes/header.php"); ?>
		</header>
		<nav>
			<div id="alaune"><p><a href="index.html">à la une</a></p></div>
			<div id="onglet_actif"><img src="images/menu_onglets/exposition.png" alt="exposition" width="140" height="35" /></div>
